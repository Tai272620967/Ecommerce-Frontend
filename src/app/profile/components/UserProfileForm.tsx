  ...
  return (
    <form className="user-profile-form" onSubmit={handleSubmit(onSubmit)}>
      <div className="user-profile-form__avatar-section">
        <div className="user-profile-form__avatar-wrapper">
          <Image
            src={avatarPreview || getDefaultAvatar()}
            alt="User Avatar"
            width={150}
            height={150}
            className="user-profile-form__avatar"
            unoptimized
            onError={(e) => {
        ...
        <div className="user-profile-form__avatar-upload">
      ...
      <div className="user-profile-form__fields">
        ...
        <div className="user-profile-form__button-wrapper">
          <Button
            type="submit"
